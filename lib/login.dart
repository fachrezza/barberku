...
import 'package:barberku/view/admin/home_admin.dart';
import 'package:barberku/view/pelanggan/home_pelanggan.dart';
                        ...
                        onTap: () async {
                          if (formkey.currentState!.validate()) {
                            try {
                              ...
                              } else if (signUser!.role == "pelanggan") {
                                showDialog(
                                  context: context,
                                  builder: (BuildContext context) {
                                    return AlertDialog(
                                      title: const Text(
                                          'Login Pelanggan Successful'),
                                      content: const Text(
                                          'You have been successfully Loginned.'),
                                      actions: <Widget>[
                                        TextButton(
